...
const IPC = {
  ...
  bleDevices: 'ipc.bleDevices',
  bleDeviceSelected: 'ipc.bleDeviceSelected',
  bleDeferredSelect: 'ipc.bleDeferredSelect',
  bleSelectionTimeout: 'ipc.bleSelectionTimeout',
  systemAudioCreateLoopback: 'system-audio:create-loopback',
  systemAudioCleanupLoopback: 'system-audio:cleanup-loopback',
  systemAudioMacMultiOutput: 'system-audio:mac-multi-output',
...
const PR = { // Global progress functions
  ...
  mediaAnalysis: 'pr.mediaanalysis',
  bpm: 'pr.bpm',
  tumblr: 'pr.tumblr',
  reddit: 'pr.reddit',
  twitter: 'pr.twitter',
