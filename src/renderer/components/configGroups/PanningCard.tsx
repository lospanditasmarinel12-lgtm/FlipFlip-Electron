...
class PanningCard extends React.Component {
  ...
  render() {
    ...
    return (
      <Grid container spacing={this.props.scene.panning ? 2 : 0} alignItems="center" sx={this.props.tutorial != null ? { pointerEvents: 'none' } : undefined}>
        <Grid item xs={12}>
          <FormControlLabel
            control={
        ...
        <Grid item xs={12}>
          <FullWidthCollapse in={this.props.scene.panning}>
            <Divider />
          </FullWidthCollapse>
        </Grid>
        <Grid item xs={12}>
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12} sm={!this.props.sidebar && this.props.scene.panHorizTransType != HTF.none ? 5 : 12}>
              <FullWidthCollapse in={this.props.scene.panning} sx={(theme) => ({
            ...
            <Grid item xs={12} sm={!this.props.sidebar && this.props.scene.panHorizTransType != HTF.none ? 7 : 12}
                  sx={(!this.props.scene.panning || this.props.scene.panHorizTransType == HTF.none) ? { p: '0 !important' } : undefined}>
              <FullWidthCollapse in={this.props.scene.panning && !this.props.scene.panHorizTransImg && this.props.scene.panHorizTransType != HTF.none} sx={(theme) => ({
                [theme.breakpoints.up('sm')]: {
                  paddingLeft: theme.spacing(1),
                },
              })}>
              ...
              <FullWidthCollapse in={this.props.scene.panning && this.props.scene.panHorizTransType != HTF.none} sx={(theme) => ({
                [theme.breakpoints.up('sm')]: {
                  paddingLeft: theme.spacing(1),
                },
              })}>
            ...
            <Grid item xs={12} sx={(!this.props.scene.panning || this.props.scene.panHorizTransType == HTF.none) ? { p: '0 !important' } : undefined}>
              <FullWidthCollapse in={this.props.scene.panning && !this.props.scene.panHorizTransImg && this.props.scene.panHorizTransType != HTF.none && !this.props.scene.panHorizTransRandom}>
                <Grid container spacing={2} alignItems="center">
                  <Grid item xs>
                    <Slider
        ...
        <Grid item xs={12} sx={!this.props.scene.panning ? { p: '0 !important' } : undefined}>
          <FullWidthCollapse in={this.props.scene.panning}>
            <Divider />
          </FullWidthCollapse>
        </Grid>
        <Grid item xs={12}>
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid item xs={12} sm={!this.props.sidebar && this.props.scene.panVertTransType != VTF.none ? 7 : 12}
                  sx={(!this.props.scene.panning || this.props.scene.panVertTransType == VTF.none) ? { p: '0 !important' } : undefined}>
              <FullWidthCollapse in={this.props.scene.panning && !this.props.scene.panVertTransImg && this.props.scene.panVertTransType != VTF.none} sx={(theme) => ({
                [theme.breakpoints.up('sm')]: {
                  paddingLeft: theme.spacing(1),
                },
              })}>
              ...
              <FullWidthCollapse in={this.props.scene.panning && this.props.scene.panVertTransType != VTF.none} sx={(theme) => ({
                [theme.breakpoints.up('sm')]: {
                  paddingLeft: theme.spacing(1),
                },
              })}>
            ...
            <Grid id="test" item xs={12} sx={(!this.props.scene.panning || this.props.scene.panVertTransType == VTF.none) ? { p: '0 !important' } : undefined}>
              <FullWidthCollapse in={this.props.scene.panning && !this.props.scene.panVertTransImg && this.props.scene.panVertTransType != VTF.none && !this.props.scene.panVertTransRandom}>
                <Grid container spacing={2} alignItems="center">
                  <Grid item xs>
                    <Slider
          ...
          <FullWidthCollapse in={this.props.scene.panning}>
            <Grid container spacing={2} alignItems="center">
              ...
              <Grid item xs={12} sm={this.props.sidebar ? 12 : 8}>
                <FullWidthCollapse in={this.props.scene.panning && this.props.scene.panTF == TF.sin}>
                ...
                <FullWidthCollapse in={this.props.scene.panning && this.props.scene.panTF == TF.bpm}>
                  <Typography variant="caption" component="div" color="textSecondary">
                ...
                <FullWidthCollapse in={this.props.scene.panning && this.props.scene.panTF == TF.constant}>
                  <TextField
                    variant="outlined"
                    label="For"
                    margin="dense"
        ...
        <Grid item xs={12}>
          <FullWidthCollapse in={this.props.scene.panning && (this.props.scene.panTF == TF.random || this.props.scene.panTF == TF.sin)}>
            <Grid container alignItems="center">
              <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                <TextField
                  variant="outlined"
            ...
            <Grid item xs={12}>
              <FullWidthCollapse in={this.props.scene.panning}>
                <Grid container spacing={2} alignItems="center">
                  ...
                  <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                    <FullWidthCollapse in={this.props.scene.panStartEase == EA.polyIn || this.props.scene.panStartEase == EA.polyOut || this.props.scene.panStartEase == EA.polyInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
                    ...
                    <FullWidthCollapse in={this.props.scene.panStartEase == EA.backIn || this.props.scene.panStartEase == EA.backOut || this.props.scene.panStartEase == EA.backInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
                  ...
                  <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                    <FullWidthCollapse in={this.props.scene.panStartEase == EA.elasticIn || this.props.scene.panStartEase == EA.elasticOut || this.props.scene.panStartEase == EA.elasticInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
                  ...
                  <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                    <FullWidthCollapse in={this.props.scene.panEndEase == EA.polyIn || this.props.scene.panEndEase == EA.polyOut || this.props.scene.panEndEase == EA.polyInOut}>
                    <Typography variant="caption" component="div" color="textSecondary">
                    ...
                    <FullWidthCollapse in={this.props.scene.panEndEase == EA.backIn || this.props.scene.panEndEase == EA.backOut || this.props.scene.panEndEase == EA.backInOut}>
                    <Typography variant="caption" component="div" color="textSecondary">
                  ...
                  <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                    <FullWidthCollapse in={this.props.scene.panEndEase == EA.elasticIn || this.props.scene.panEndEase == EA.elasticOut || this.props.scene.panEndEase == EA.elasticInOut}>
                    <Typography variant="caption" component="div" color="textSecondary">
