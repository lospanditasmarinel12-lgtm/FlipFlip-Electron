...
class FadeIOCard extends React.Component {
  ...
  render() {
    ...
    return (
      <Grid container spacing={this.props.scene.fadeInOut ? 2 : 0} alignItems="center" sx={this.props.tutorial != null ? { pointerEvents: 'none' } : undefined}>
        <Grid item xs={12}>
          <FormControlLabel
            control={
          ...
          <FullWidthCollapse in={this.props.scene.fadeInOut}>
            <Grid container spacing={2} alignItems="center">
              ...
              <Grid item xs={12} sm={this.props.sidebar ? 12 : 8}>
                ...
                <FullWidthCollapse in={this.props.scene.fadeIOTF == TF.constant}>
                  <TextField
                    variant="outlined"
                    label="For"
                    margin="dense"
        ...
        <Grid item xs={12}>
          <FullWidthCollapse in={this.props.scene.fadeInOut && (this.props.scene.fadeIOTF == TF.random || this.props.scene.fadeIOTF == TF.sin)}>
            <Grid container alignItems="center">
            ...
            <Grid item xs={12}>
              <FullWidthCollapse in={this.props.scene.fadeInOut}>
                <Grid container spacing={2} alignItems="center">
                  ...
                  <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                    <FullWidthCollapse in={this.props.scene.fadeIOStartEase == EA.polyIn || this.props.scene.fadeIOStartEase == EA.polyOut || this.props.scene.fadeIOStartEase == EA.polyInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
                    ...
                    <FullWidthCollapse in={this.props.scene.fadeIOStartEase == EA.backIn || this.props.scene.fadeIOStartEase == EA.backOut || this.props.scene.fadeIOStartEase == EA.backInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
                  ...
                  <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                    <FullWidthCollapse in={this.props.scene.fadeIOStartEase == EA.elasticIn || this.props.scene.fadeIOStartEase == EA.elasticOut || this.props.scene.fadeIOStartEase == EA.elasticInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
                  ...
                  <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                    <FullWidthCollapse in={this.props.scene.fadeIOEndEase == EA.polyIn || this.props.scene.fadeIOEndEase == EA.polyOut || this.props.scene.fadeIOEndEase == EA.polyInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
                    ...
                    <FullWidthCollapse in={this.props.scene.fadeIOEndEase == EA.backIn || this.props.scene.fadeIOEndEase == EA.backOut || this.props.scene.fadeIOEndEase == EA.backInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
                  ...
                  <Grid item xs={12} sm={this.props.sidebar ? 12 : 6}>
                    <FullWidthCollapse in={this.props.scene.fadeIOEndEase == EA.elasticIn || this.props.scene.fadeIOEndEase == EA.elasticOut || this.props.scene.fadeIOEndEase == EA.elasticInOut}>
                      <Typography variant="caption" component="div" color="textSecondary">
