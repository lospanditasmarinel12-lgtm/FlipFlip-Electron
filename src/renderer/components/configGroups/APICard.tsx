...
const iconAvatarSx = { float: 'right', backgroundColor: 'primary.light' };
...
class APICard extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Typography align="center" sx={{ pb: 1 }}>API Sign In</Typography>
        ...
        <Grid container spacing={2} alignItems="center" justifyContent="center">
          <Grid item>
            <Tooltip disableInteractive title={tumblrAuthorized ? "Authorized: Click to Sign Out of Tumblr" : "Unauthorized: Click to Authorize Tumblr"}  placement="top-end">
              <Fab
                sx={[fabSx, tumblrAuthorized ? { bgcolor: 'primary.main' } : { bgcolor: 'error.main' }]}
                onClick={tumblrAuthorized ? this.onClearTumblr.bind(this) : this.onAuthTumblr.bind(this)}
                size="large">
                <SourceIcon sx={iconSx} type={ST.tumblr}/>
              </Fab>
            </Tooltip>
          </Grid>
          {/*<Grid item>
            <Tooltip disableInteractive title={redditAuthorized ? "Authorized: Click to Sign Out of Reddit" : "Unauthorized: Click to Authorize Reddit"}  placement="top-end">
              <Fab
                sx={[fabSx, redditAuthorized ? { bgcolor: 'primary.main' } : { bgcolor: 'error.main' }]}
                onClick={redditAuthorized ? this.onClearReddit.bind(this) : this.onAuthReddit.bind(this)}
                size="large">
                <SourceIcon sx={iconSx} type={ST.reddit}/>
              </Fab>
            </Tooltip>
          </Grid>*/}
          {/*<Grid item>
            <Tooltip disableInteractive title={twitterAuthorized ? "Authorized: Click to Sign Out of Twitter" : "Unauthorized: Click to Authorize Twitter"}  placement="top-end">
              <Fab
                sx={[fabSx, twitterAuthorized ? { bgcolor: 'primary.main' } : { bgcolor: 'error.main' }]}
                onClick={twitterAuthorized ? this.onClearTwitter.bind(this) : this.onAuthTwitter.bind(this)}
                size="large">
                <SourceIcon sx={iconSx} type={ST.twitter}/>
              </Fab>
            </Tooltip>
          </Grid>*/}
          <Grid item>
            <Tooltip disableInteractive title={instagramConfigured ? "Authorized: Click to Sign Out of Instagram" : "Unauthorized: Click to Authorize Instragram"}  placement="top-end">
              <Fab
                sx={[fabSx, instagramConfigured ? { bgcolor: 'primary.main' } : { bgcolor: 'error.main' }]}
                onClick={instagramConfigured ? this.onClearInstagram.bind(this) : this.onAuthInstagram.bind(this)}
                size="large">
                <SourceIcon sx={iconSx} type={ST.instagram}/>
              </Fab>
            </Tooltip>
          </Grid>
          <Grid item>
            <Tooltip disableInteractive title={hydrusConfigured ? "Configured: Click to Remove Hydrus Configuration" : "Unauthorized: Click to Configure Hydrus"}  placement="top-end">
              <Fab
                sx={[fabSx, hydrusConfigured ? { bgcolor: 'primary.main' } : { bgcolor: 'error.main' }]}
                onClick={hydrusConfigured ? this.onClearHydrus.bind(this) : this.onAuthHydrus.bind(this)}
                size="large">
                <SourceIcon sx={iconSx} type={ST.hydrus}/>
              </Fab>
            </Tooltip>
          </Grid>
          <Grid item>
            <Tooltip disableInteractive title={rule34Configured ? "Configured: Click to Remove Rule34 Configuration" : "Unauthorized: Click to Configure Rule34"}  placement="top-end">
              <Fab
                sx={[fabSx, rule34Configured ? { bgcolor: 'primary.main' } : { bgcolor: 'error.main' }]}
                onClick={rule34Configured ? this.onClearRule34.bind(this) : this.onAuthRule34.bind(this)}
                size="large">
                <SourceIcon sx={iconSx} type={ST.rule34}/>
              </Fab>
            </Tooltip>
          </Grid>
          <Grid item>
            <Tooltip disableInteractive title={gelbooruConfigured ? "Configured: Click to Remove Gelbooru Configuration" : "Unauthorized: Click to Configure Gelbooru"}  placement="top-end">
              <Fab
                sx={[fabSx, gelbooruConfigured ? { bgcolor: 'primary.main' } : { bgcolor: 'error.main' }]}
                onClick={gelbooruConfigured ? this.onClearGelbooru.bind(this) : this.onAuthGelbooru.bind(this)}
                size="large">
                <SourceIcon sx={iconSx} type={ST.gelbooru}/>
              </Fab>
            </Tooltip>
          </Grid>
          <Grid item>
            <Tooltip disableInteractive title={piwigoConfigured ? "Configured: Click to Remove Piwigo Configuration" : "Unauthorized: Click to Configure Piwigo"}  placement="top-end">
              <Fab
                sx={[fabSx, piwigoConfigured ? { bgcolor: 'primary.main' } : { bgcolor: 'error.main' }]}
                onClick={piwigoConfigured ? this.onClearPiwigo.bind(this) : this.onAuthPiwigo.bind(this)}
                size="large">
                <SourceIcon sx={iconSx} type={ST.piwigo}/>
              </Fab>
            </Tooltip>
          </Grid>
        ...
        <Dialog
          ...
          <DialogTitle id="sign-out-title">
            {menuType} Sign Out
            <Avatar sx={iconAvatarSx}>
              <SourceIcon sx={iconSx} type={this.state.menuType}/>
            </Avatar>
          </DialogTitle>
          <DialogContent>
