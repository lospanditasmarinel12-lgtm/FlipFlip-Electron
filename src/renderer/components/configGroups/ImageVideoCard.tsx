  ...
  render() {
    ...
    return (
      <Grid container alignItems="center">
        {!this.props.isPlayer && (
          <Grid container spacing={2} alignItems="center" sx={[{ mb: 2 }, this.props.tutorial == SDT.imageOptions && highlightSx]}>
            ...
            <Grid item xs={12} sm={this.props.sidebar ? 12 : 6} sx={this.props.scene.imageTypeFilter == IF.videos ? noPaddingSx : undefined}>
            ...
            <Grid item xs={12} sm={6} sx={noPaddingSx}>
            </Grid>
            <Grid item xs={12} sm={this.props.sidebar ? 12 : 6} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.videos) ? noPaddingSx : undefined}>
            ...
            <Grid item xs={12} sm={this.props.sidebar ? 12 : 6} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.videos || this.props.scene.gifOption == GO.none || this.props.scene.gifOption == GO.full) ? noPaddingSx : undefined}>
        ...
        <Grid container spacing={2} alignItems="center" sx={this.props.tutorial == SDT.videoOptions ? highlightSx : undefined}>
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 6} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.images) ? noPaddingSx : undefined}>
          ...
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 6} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.images || this.props.scene.videoOption == VO.none || this.props.scene.videoOption == VO.full) ? noPaddingSx : undefined}>
          ...
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 8} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.images) ? noPaddingSx : undefined}>
          ...
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 4} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.images) ? noPaddingSx : undefined}>
            <Collapse in={this.props.scene.imageTypeFilter != IF.stills && this.props.scene.imageTypeFilter != IF.images}>
              <FormControlLabel
                control={
          ...
          <Grid item xs={12} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.images) ? noPaddingSx : undefined}>
            <Collapse in={this.props.scene.imageTypeFilter != IF.stills && this.props.scene.imageTypeFilter != IF.images}>
              <Typography variant="caption" component="div"
                          color="textSecondary">
          ...
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 4} md={this.props.sidebar ? 12 : 6} lg={this.props.sidebar ? 12 : 4} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.images) ? noPaddingSx : undefined}>
            <Collapse in={this.props.scene.imageTypeFilter != IF.stills && this.props.scene.imageTypeFilter != IF.images}>
              <FormControlLabel
                control={
          ...
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 4} md={this.props.sidebar ? 12 : 6} lg={this.props.sidebar ? 12 : 4} sx={noPaddingSx}>
          </Grid>
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 4} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.images) ? noPaddingSx : undefined}>
            <Collapse in={this.props.scene.imageTypeFilter != IF.stills && this.props.scene.imageTypeFilter != IF.images}>
              <FormControlLabel
          ...
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 4} sx={(this.props.scene.imageTypeFilter == IF.stills || this.props.scene.imageTypeFilter == IF.images || this.props.scene.playVideoClips) ? noPaddingSx : undefined}>
        ...
        <Grid container spacing={2} alignItems="center">
          {!this.props.isPlayer && (
            <Grid item xs={12} sm={this.props.sidebar ? 12 : 4} sx={this.props.tutorial == SDT.weighting ? highlightSx : undefined}>
          ...
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 4} sx={this.props.tutorial == SDT.sordering ? highlightSx : undefined}>
            <FormControl variant="standard" component="fieldset">
          ...
          <Grid item xs={12} sm={this.props.sidebar ? 12 : 4} sx={this.props.tutorial == SDT.ordering ? highlightSx : undefined}>
            <FormControl variant="standard" component="fieldset">
