  ...
  getPhrase(value: string) {
    ...
    if (value == "$RANDOM_PHRASE") {
      ...
      if (this.props.currentImage) {
        const source = typeof this.props.currentImage.getAttribute === 'function' ? this.props.currentImage.getAttribute("source") : this.props.currentImage.source;
        const tag = getRandomListItem(this.props.getTags(source, undefined).filter((t) => t.phraseString && t.phraseString != ""));
        if (tag) {
