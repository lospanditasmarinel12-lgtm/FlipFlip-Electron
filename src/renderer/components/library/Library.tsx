...
import {filterSource, getCachePath, getLocalPath, listChanged} from "../../data/utils";
...
class Library extends React.Component {
              ...
              <Box sx={(theme) => ({
                ...
                {tumblrAuthorized && (
                  <Tooltip disableInteractive title={this.state.drawerOpen ? "" : "Import from Tumblr"}>
                    <ListItemButton disabled={this.props.progressMode != null} onClick={this.props.onImportTumblr.bind(this)}>
                      <ListItemIcon>
                ...
                {instagramAuthorized && (
                  <Tooltip disableInteractive title={this.state.drawerOpen ? "" : "Import from Instagram"}>
                    <ListItemButton disabled={this.props.progressMode != null} onClick={this.props.onImportInstagram.bind(this)}>
                      <ListItemIcon>
          ...
          <React.Fragment>
            ...
            <Tooltip disableInteractive title={this.state.filters.length > 0 ? "" : "Local Video/Playlist"}  placement="left">
              <Fab
                ...
                size="small">
                <MovieIcon sx={(theme) => ({ color: theme.palette.primary.contrastText })} />
              </Fab>
            </Tooltip>
  ...
  componentDidUpdate(props: any, state: any) {
    if (state.filters != this.state.filters || props.library != this.props.library || listChanged(props.library, this.props.library) || props.specialMode != this.props.specialMode) {
      this.setState({displaySources: this.getDisplaySources()});
    }
  ...
  onOpenImportFile() {
    remote.dialog.showOpenDialog(remote.getCurrentWindow(),
      {filters: [{name:'All Files (*.*)', extensions: ['*']},{name: 'JSON Document', extensions: ['json']}], properties: ['openFile']}).then(result => {
...
function LibraryWrapper(props: any) {
  ...
  return <Library {...props} {...progress} />;
}
(LibraryWrapper as any).displayName = "LibraryWrapper";
