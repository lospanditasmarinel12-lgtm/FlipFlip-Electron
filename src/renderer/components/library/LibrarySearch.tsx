...
class LibrarySearch extends React.Component {
  readonly props: {
    displaySources: Array<LibrarySource | Audio | CaptionScript>,
    tags: Array<Tag>,
    ...
    <div>
      <components.Option {...props}>
        {this.props.showCheckboxes &&
          <Checkbox sx={{ color: grey[900] }} checked={props.isSelected} onChange={() => null}/>
        }
    ...
    if (this.props.isCreatable) {
      return (
        <Box sx={(theme) => ({
          ...
          color: grey[900],
          ...(!this.props.fullWidth && { maxWidth: `calc(100% - ${theme.spacing(7)})` }),
        })}>
          <CreatableSelect
