  ...
  render() {
      ...
      case SPT.welcome:
        dialogBody =
          <React.Fragment>
            ...
            <DialogActions>
              <Button onClick={this.onSkipAll.bind(this)} color="inherit" sx={{ color: 'error.main' }}>
                Skip ALL Tutorials
              </Button>
          ...
          <React.Fragment>
            ...
            <DialogContent>
              ...
              <DialogContentText id="tutorial-description">
                ...
                <br/>
                <DeleteIcon sx={{ color: 'error.main' }} color="inherit"/> Delete Source
              </DialogContentText>
            </DialogContent>
            <DialogActions>
              <Button onClick={this.onContinue.bind(this)} color="primary">
    ...
    return(
      <Dialog
        ...
        slotProps={{container: {sx: {justifyContent: left ? 'flex-start' : right ? 'flex-end' : undefined, alignItems: top ? 'flex-start' : bottom ? 'flex-end' : undefined}}}}
